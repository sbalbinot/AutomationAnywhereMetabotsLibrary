...
namespace Programming
{
    class Program
    {
        ...
        public static void Main()
        {
            ...
            //string retorno = x.fileFindAllXPathValues(xmlFile, "//ConsultaGuia/guias/guia/principal[../principal/text()='202002552375' and ../chaveGuia/text()!='202002552375']");////Row/movimentos/movimento/cdMovimento[(../tipo/text()='I') and (string(../insOpme/text())='' or ../insOpme/text()='0') and (string(../insDiaria/text())='' or ../insDiaria/text()='0') and (../nrPacote/text()='0' or string(../nrPacote/text())='')]
            string retorno = x.fileGetXPathAttributeValue(xmlFile, "//ConsultaGuia/guias/guia[./principal/text()='202002552375' and ./chaveGuia/text()!='202002552375']", "ID");
